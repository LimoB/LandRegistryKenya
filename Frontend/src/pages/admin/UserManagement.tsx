...
import { setSelectedUser, openViewModal } from "../../features/users/userSlice";
          ...
          <tbody className="divide-y divide-slate-100 dark:divide-slate-900">
            {isLoading ? (
              <tr>
                <td
                  colSpan={5}
                  className="py-20 text-center animate-pulse font-bold text-slate-400 uppercase text-xs"
                >
                  Decrypting User Records...
                </td>
              </tr>
            ) : (
              users.map((user) => (
                ...
                >
                  ...
                  <td className="px-8 py-5">
                    <span
                      className={`text-[10px] font-black uppercase px-3 py-1 rounded-lg border ${
                        user.role === "admin"
